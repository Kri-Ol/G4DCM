...
void DicomDetectorConstruction::ConstructPhantom()
{
#ifdef G4VERBOSE
  ...
  G4PVParameterised * phantom_phys = new G4PVParameterised("phantom",voxel_logic,fContainer_logic, kXAxis, fNVoxelX*fNVoxelY*fNVoxelZ, param);
